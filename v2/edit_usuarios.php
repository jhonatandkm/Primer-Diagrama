...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update_user"])) {
    ...
    try{
        $update_sql = "UPDATE usuarios SET nombre='$newName', apellido='$newLastName', email='$newEmail', direccion='$newAddress' WHERE id_usuario='$userId'";
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $userId = $_GET['id'];
    $select_sql = "SELECT * FROM usuarios WHERE id_usuario='$userId'";
